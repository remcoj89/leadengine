<?php
/**
 * Title: Section Light Background Flex Image Left
 * Slug: leadmagnet/section-light-bg-flex-image-left
 * Description: A section with a light background color, an image on the left, and text content on the right.
 * Categories: Sections
 * Inserter: yes
 */
?>
