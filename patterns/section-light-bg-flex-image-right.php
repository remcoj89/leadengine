<?php
/**
 * Title: Section Light Background Flex Image Right
 * Slug: leadmagnet/section-light-bg-flex-image-right
 * Description: A section with a light background color, an image on the Right, and text content on the left.
 * Categories: Sections
 * Inserter: yes
 */
?>
...
<!-- wp:generateblocks/element {"uniqueId":"109a38bd","tagName":"div","styles":{"paddingTop":"5rem","paddingBottom":"5rem","backgroundColor":"var(\u002d\u002dwp\u002d\u002dpreset\u002d\u002dcolor\u002d\u002dsoft-linen, #F5F0E6)"},"css":".gb-element-109a38bd{background-color:var(\u002d\u002dwp\u002d\u002dpreset\u002d\u002dcolor\u002d\u002dsoft-linen,#F5F0E6);padding-bottom:5rem;padding-top:5rem}","metadata":{"name":"Flex Section LIght BG Image Left"}} -->
<div class="gb-element-109a38bd">
  ...
  <div class="wp-block-group">
    ...
    <div class="gb-element-7a10d5f5">
      ...
      <!-- wp:generateblocks/element {"uniqueId":"7a4f940e","tagName":"div","styles":{"textAlign":"left","alignItems":"flex-start","display":"flex","flexDirection":"column","justifyContent":"center","maxWidth":"65ch"},"css":".gb-element-7a4f940e{align-items:flex-start;display:flex;flex-direction:column;justify-content:center;max-width:65ch;text-align:left}"} -->
