<?php
/**
 * Title: Section Flex Card Light
 * Slug: leadmagnet/section-flex-card-light
 * Description:A flex section with card style layout and light background.
 * Categories: section
 * Inserter: yes
 */
?>
...
<div class="gb-element-1469b780">
  ...
  <div class="wp-block-group">
    <!-- wp:generateblocks/element {"uniqueId":"0ebeecdb","tagName":"div","styles":{"display":"grid","gridTemplateColumns":"repeat(2, minmax(0, 1fr))","columnGap":"2rem","rowGap":"2rem","@media (max-width:767px)":{"gridTemplateColumns":"1fr"},"backgroundColor":"var(\u002d\u002dwp\u002d\u002dpreset\u002d\u002dcolor\u002d\u002dsoft-linen, #F5F0E6)","paddingTop":"4rem","paddingBottom":"4rem","paddingRight":"4rem","paddingLeft":"4rem","borderTopLeftRadius":"16px","borderTopRightRadius":"16px","borderBottomRightRadius":"16px","borderBottomLeftRadius":"16px","width":"50%","@media (max-width:1024px)":{"gridTemplateColumns":"1fr","paddingLeft":"2.5rem","paddingRight":"2.5rem","paddingBottom":"2.5rem","paddingTop":"2.5rem","marginLeft":"2.5rem","marginRight":"2.5rem","width":"unset"}},"css":".gb-element-0ebeecdb{background-color:var(\u002d\u002dwp\u002d\u002dpreset\u002d\u002dcolor\u002d\u002dsoft-linen,#F5F0E6);column-gap:2rem;display:grid;grid-template-columns:repeat(2,minmax(0,1fr));row-gap:2rem;width:50%;border-radius:16px;padding:4rem}@media (max-width:1024px){.gb-element-0ebeecdb{grid-template-columns:1fr;margin-left:2.5rem;margin-right:2.5rem;width:unset;padding:2.5rem}}@media (max-width:767px){.gb-element-0ebeecdb{grid-template-columns:1fr}}"} -->
    <div class="gb-element-0ebeecdb">
      <!-- wp:generateblocks/element {"uniqueId":"b435338a","tagName":"div","styles":{"display":"grid","gridTemplateColumns":"1fr","rowGap":"1rem"},"css":".gb-element-b435338a{display:grid;grid-template-columns:1fr;row-gap:1rem}"} -->
      <div class="gb-element-b435338a">
        <!-- wp:heading -->
      ...
      <!-- wp:generateblocks/element {"uniqueId":"441e54cc","tagName":"div","styles":{"display":"block"},"css":".gb-element-441e54cc{display:block}"} -->
      <div class="gb-element-441e54cc">
        <!-- wp:paragraph -->
